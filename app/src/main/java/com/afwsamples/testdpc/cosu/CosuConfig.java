...
/* package */ class CosuConfig {
    ...
    private final Set<String> mHideApps = new HashSet<>();
    private final Set<String> mEnableSystemApps = new HashSet<>();
    private final Set<String> mKioskApps = new HashSet<>();
    private final Set<DownloadAppInfo> mDownloadApps = new HashSet<>();
    private final Set<String> mUserRestrictions = new HashSet<>();
    private final Set<GlobalSetting> mGlobalSettings = new HashSet<>();
