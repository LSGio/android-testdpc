...
public class DpcPreferenceHelper {
    ...
    public static final @AdminKind
    int ADMIN_DEFAULT = ADMIN_NOT_NONE;
    ...
    public static final @UserKind
    int USER_DEFAULT = USER_ANY;
    ...
    private final List<CustomConstraint> mCustomConstraints = new ArrayList<>();
    private final String mDelegationConstraint;
    private CharSequence mConstraintViolationSummary = null;
    private int mMinSdkVersion;
    private @AdminKind
    int mAdminConstraint;
    private @UserKind
    int mUserConstraint;
